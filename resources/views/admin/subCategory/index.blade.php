            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="{{ route('subCategory.create') }}" class="btn btn-icon btn-left btn-primary"><i
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped">
                                <tr>
                                    ...
                                    <th class="p-0 text-center">SubCategory Name</th>
                                    <th class="p-0 text-center">Slug</th>
                                    <th class="p-0 text-center">Description</th>
                                    <th class="p-0 text-center">Parent Category</th>
                                ...
                                <tr>
                                    ...
                                    <td class="p-0 text-center">{{ $category->category->name }}</td>
                                    <td class="p-0 text-center">{{ $category->position_id }}</td>
                                    <td class="p-0 text-center">
                                        <div style="margin: 0 auto; width: 60px; overflow: hidden">
                                            <img class="img-fluid"
                                                src="{{ asset('images/subCategory/'. $category->image) }}" alt="catImg">
                                        </div>
                                    </td>
                                    <td class="p-0 text-center">
                                    ...
                                    <td class="p-0 text-center">
                                        <a class="btn btn-sm btn-warning btn-xs"
                                            href="{{ route('subCategory.edit', $category->id) }}"><i
